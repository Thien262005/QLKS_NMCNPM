...
document.addEventListener("DOMContentLoaded", function () {
  if (document.querySelector(".permission-group")) {
    const groupMasterCheckboxes = document.querySelectorAll(
    ...
    groupMasterCheckboxes.forEach((masterCheckbox) => {
      masterCheckbox.addEventListener("change", function () {
        ...
        const childCheckboxes = groupContainer.querySelectorAll(
    ...
    allChildCheckboxes.forEach((childCheckbox) => {
      childCheckbox.addEventListener("change", function () {
        const groupContainer = this.closest(".permission-group");
        const masterCheckbox = groupContainer.querySelector(
          '.group-title input[type="checkbox"]'
        );
        const siblings = groupContainer.querySelectorAll(
          '.checkbox-list input[type="checkbox"]'
        );
    ...
    // Xử lý nút Áp dụng
    const applyBtn =
      document.getElementById("applyPermissionBtn") ||
      document.querySelector(".permission-filter .btn-primary");
